...
import { Eye, EyeOff, Mail, Lock, User, Globe, Sparkles, Star } from 'lucide-react'
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white border border-brand-purple/18 text-sm text-content-secondary hover:bg-surface-subtle hover:text-content-primary hover:border-brand-purple/30 transition-all shadow-card">
              ...
              <button className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white border border-brand-purple/18 text-sm text-content-secondary hover:bg-surface-subtle hover:text-content-primary hover:border-brand-purple/30 transition-all shadow-card">
                <svg className="w-4 h-4 fill-current text-content-primary" viewBox="0 0 24 24">
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.7 9.05 7.4c1.39.07 2.34.74 3.15.8 1.19-.24 2.33-.93 3.6-.84 1.53.12 2.68.72 3.44 1.85-3.1 1.87-2.38 5.98.48 7.13-.57 1.52-1.31 3.03-2.67 3.94zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                </svg>
                Apple
              </button>
            </div>
